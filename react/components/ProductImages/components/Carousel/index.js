...
import SwiperCore, { Thumbs, Navigation, Pagination, Mousewheel, Scrollbar } from 'swiper'
...
SwiperCore.use([Thumbs, Navigation, Pagination, Mousewheel, Scrollbar])
  ...
  render() {
    ...
    const thumbnailSwiper = (
      <ThumbnailSwiper
        ...
        hasThumbMousewheel={hasThumbMousewheel}
        slides={slides}
        position={position}
      />
    )
        ...
        <div className={imageClasses}>
          {!this.state.thumbSwiper?.destroyed && (
            <Swiper
              ...
              mousewheel={hasMousewheelControl}
              scrollbar={true}
              // scrollbar={{hide: true,}}
              modules={[Scrollbar]}
